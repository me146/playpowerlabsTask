...
function create_second_container(dabo)
{
            
            second_container.width=window.screen.availWidth;
            second_container.width=Math.min(window.screen.availWidth,600 );
            second_container.height=window.innerHeight;
            second_container.x =0;
            



            app.stage.addChild(second_container);
            xyz=second_container;
            let second_rectangle = new PIXI.Graphics();
            second_rectangle.beginFill(0x1b1054);
            second_rectangle.drawRect(0, 0,Math.min(window.screen.availWidth,600 ),window.innerHeight );
            second_rectangle.endFill();
            second_rectangle.x =(window.screen.availWidth-(Math.min(window.screen.availWidth,600)))/2;

            second_container.addChild(second_rectangle);

            let second_rectangle_tittle = new PIXI.Graphics();
            second_rectangle_tittle.beginFill(0x231863);
            second_rectangle_tittle.drawRect(0, 0,Math.min(window.screen.availWidth,600 ),window.innerHeight*8/100 );
            ...
            second_container.addChild(second_rectangle_tittle);
            ...
            second_container.addChild(second_rectangle_tittle_text);
            ...
            second_container.addChild(second_rectangle_roundBox1);
            second_container.addChild(second_rectangle_instruction);
            ...
            second_container.addChild(second_rectangle_roundBox2);
            second_container.addChild(second_rectangle_tips);
            ...
            var second_rectangle_start_text=new PIXI.Text("Start",style3);
            ...
            second_container.addChild(second_rectangle_button);
            second_container.addChild(second_rectangle_start_text);
            ...
            function clickthyu()
            {
                second_container.visible=false;
                //alert(second_container.visible);
